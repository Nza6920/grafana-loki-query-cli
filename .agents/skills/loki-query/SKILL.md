...
4. Before every follow-up query, ask for approval if it switches profiles or widens beyond one hour. Never widen beyond 24 hours. Complete this step when the next query stays within the current boundary or the user approves the change.
